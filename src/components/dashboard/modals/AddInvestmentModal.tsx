...
import { addInvestment, getCurrentUser } from '../../../lib/supabase';
...
export const AddInvestmentModal: React.FC<AddInvestmentModalProps> = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: addError } = await addInvestment({
        user_id: user.id,
